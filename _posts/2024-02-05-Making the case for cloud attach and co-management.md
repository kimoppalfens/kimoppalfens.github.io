...
The flow of an Azure AD only client authenticating against a Configuration Manager backed in documented clearly on [Micosoft's documentation page](https://learn.microsoft.com/en-us/mem/configmgr/core/clients/manage/azure-ccmsetup)

A second misconception that appears to be out there is that managing clients with Configuration Managed introduces the need for VPN style solutions to connect to the Configuration Manager backend. So, repeat after me once more,
