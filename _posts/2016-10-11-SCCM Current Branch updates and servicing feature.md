...
<ol>
	<li>This particular update is somewhere between 800 and 900 Mbytes, so depending on your internet connection speed, it might take a while to download everything. In my particular experience, mumbling "patience is a virtue" over and over again had neither a positive nor negative impact on the download speed.</li>
	<li>Once downloaded you should see the update in your <strong>&lt;CM Install Folder&gt;\EasySetupPayLoad</strong></li>
	<li>
<div><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup1.png" alt="" /><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup2.png" alt="" /></div></li>
	<li>If the update arrive your UI should look like the 2 screenshots below, and have the update state listed as Available.</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup3.png" alt="" /><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup4.png" alt="" /></li>
	...
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup5.png" alt="" /></li>
	<li>Next, you need to read the License agreement, and accept them. Yes, the idea is that you read them first.</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup6.png" alt="" /></li>
	<li>Subsequently you can chose to upgrade all your clients at once, or perform testing to a pre-production collection you specify. This ties into the client updating feature that was enhanced in CM2012SP1CU1 to also support cumulative update releases as opposed to the original behavior which only supported service packs.</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup7.png" alt="" /></li>
	<li>The rest of the wizard doesn't provide you with any options to configure, find screenshots below for completeness.</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup8.png" alt="" /></li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup9.png" alt="" /></li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup10.png" alt="" /></li>
	<li>At this point the Administration node will list the Update in a state "installing". Depending on your environment this installation might take a while to complete.</li>
	<li>Logfiles involved during this upgrade are dmpdownloader.log, sitecomp.log and cmupdate.log and obviously the logs for prereq checking and setup which in my case are looked in the root of the c:\ drive.</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup11.png" alt="" /></li>
	<li>In the file system you'll also notice the downloaded files are being copied to a brand new folder in your site server installation called CMUStaging</li>
	<li>Upon successful installation the <strong><em>Monitoring\Overview\Site Servicing status</em></strong> should contain a status of installed</li>
	<li>And the about screen should contain a version of 1509, please note that the Console versions and Site version remain at 5.0.8299.1000</li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup12.png" alt="" /></li>
	<li>
<div><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup13.png" alt="" /></div></li>
</ol>
<h1>Feature at work – The admin ui upgrade</h1>
...
<ol>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup14.png" alt="" /><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup15.png" alt="" /></li>
	<li><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup16.png" alt="" /></li>
	<li>Again this is a fairly regular install, so you can monitor progress by following the ConfigMgrAdminUISetup and its verbose variant.</li>
</ol>
<p style="margin-left: 18pt;"><img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup17.png" alt="" /></p>
<p style="margin-left: 18pt;"></p>

<h1>Personal observations – Notes from the <span style="text-decoration: line-through;">field</span> Lab</h1>
...
<ol>
	<li>Make sure you set the datetime format correctly</li>
	<li>Are you 100% positive you verified item 1</li>
	<li>Really?</li>
	<li>
<div>If you goofed up on 1-3 run the following command in SQL Management studio, after typing a full page in Word with the sentence "I am a goof!"</div>
<em>EXEC spCMUSetUpdatePackageState N'dcd17922-2c96-4bd7-b72d-e9159582cdf2', 262146, N''
</em></li>
</ol>
<h3>Wmi</h3>
5 new WMI classes have surfaced that seem to be related to this feature:
<ul>
	<li>SMS_CM_UpdateFeatures (0 Instances, 1 method (UpdateFeatureExposureStatus)</li>
	<li>SMS_CM_UpdatePackageFeatures (0 Instances, 1 method (UpdateFeatureExposureStatus)</li>
	<li>SMS_CM_Update_Packages (1 instance with guid of update, 2 methods (IsCurrentWorkingUpdatePackage, updatePrereqAndStateFlags)</li>
	<li>SMS_CM_UpdatePackageSiteStatus (1 instance with guid of update, no methods)</li>
	<li>SMS_CM_UpdatePackDetailedSiteStatus (multiple instances with different steps ranging from prereq checking to actual install steps. (State 3, appears to be success (to be validated)</li>
</ul>
<h3>SQL</h3>
5 new views where created related to the 5 WMI classes above:
<ul>
	<li>Vsms_CM_updatefeatures</li>
	<li>vSMS_CM_UpdatePackageFeatures</li>
	<li>vSMS_CM_UpdatePackages</li>
	<li>vSMS_CM_UpdatePackageSiteStatus</li>
	<li>vSMS_CM_LatestInstalledPackageFeatures</li>
</ul>
10 Stored procedures have surfaced that appear to be related to this new servicing feature

<img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup18.png" alt="" />

20 new tables have surfaced that appear to be related to this new servicing feature

<img src="http://scug.be/thewmiguy/files/2015/09/092415_1353_SCCMvNextup19.png" alt="" />

<span style="color: #555555; font-family: Arial; font-size: 9pt;">Enjoy.
...
http://twitter.com/thewmiguy</span>